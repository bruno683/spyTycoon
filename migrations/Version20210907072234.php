 ...
 */
final class Version20210907072234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE skills DROP missions_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE skills ADD missions_id INT DEFAULT NULL');
